...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_choixPointe_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 29, 7)
    ...
    "choixPointe\0add\0\0cible\0vocab\0sendDad\0"
};
...
const QMetaObject choixPointe::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_choixPointe.data,
      qt_meta_data_choixPointe,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_choixPointe.stringdata))
