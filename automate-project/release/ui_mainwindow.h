...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/new/prefix1/Images/back.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon10;
        icon10.addFile(QStringLiteral(":/new/prefix1/Images/next.png"), QSize(), QIcon::Normal, QIcon::Off);
