...
**
** Created: Thu 4. Mar 04:07:26 2010
...
static const char qt_meta_stringdata_choixPointe[] = {
    "choixPointe\0\0cible,vocab\0add(int,int)\0"
    "sendDad()\0"
};

const QMetaObject choixPointe::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_choixPointe,
      qt_meta_data_choixPointe, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &choixPointe::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_choixPointe))
...
int choixPointe::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: add((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: sendDad(); break;
        default: ;
        }
        _id -= 2;
    }
