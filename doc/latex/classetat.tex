...
true si cette transition existe, false sinon 
\end{DoxyReturn}
\hypertarget{classetat_adc481f8f4c2c2357a88ac925e6440a8b}{\index{etat@{etat}!find\-\_\-transition@{find\-\_\-transition}}
\index{find\-\_\-transition@{find\-\_\-transition}!etat@{etat}}
\subsubsection[{find\-\_\-transition}]{\setlength{\rightskip}{0pt plus 5cm}bool etat\-::find\-\_\-transition (
\begin{DoxyParamCaption}
\item[{{\bf etat}}]{e}
\end{DoxyParamCaption}
)}}\label{classetat_adc481f8f4c2c2357a88ac925e6440a8b}
...
Getter de l'attribut transition. Le premier membre est l'étiquette de la transition et le deuxieme est l'état ciblé par la transition.
